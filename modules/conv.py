...
class Conv(nn.Module):
    ...
    def __init__(self, c1, c2, k=1, s=1, p=None, g=1, d=1, act=True):
        ...
        super().__init__()
        # print('Conv中的c1（输入通道）与c2（输出通道）：', c1, c2)  # 打印c1和c2确认通道数
...
class Concat(nn.Module):
    ...
    def __init__(self, dimension=1):
        """Initialize with the specified dimension for concatenation."""
        super().__init__()
        self.d = dimension

    def forward(self, x):
        """Forward pass that concatenates input tensors along the specified dimension."""
